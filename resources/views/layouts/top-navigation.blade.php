                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <ul class="list-unstyled mb-0" aria-labelledby="dropdownMenuOffset">
                                                ...
                                                <li><a class="dropdown-item" href="#">Pagos anulados y pendientes</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown d-md-none topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-search-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end" aria-labelledby="configuraciones">
                                    ...
                                    <a class="dropdown-item" href="javascript:void();">Arancel de precios</a>
                                    <a class="dropdown-item" href="javascript:void();">Documentos Clínicos</a>
                                    <a class="dropdown-item" href="javascript:void();">Consentimientos informados</a>
                                    <a class="dropdown-item" href="javascript:void();">Logotipo</a>
                                    <a class="dropdown-item" href="javascript:void();">Pagos anulados y pendientes</a>
                                </div>
                            </div>
